...
def solve_auction():
    ...
    if (btn_clicked):
        ...
        list_auction_items = sl.get_items_auctioned(text_input, dataframe, "Items_Auctioned")
        st.write(list_auction_items)

        # Getting list of auctioned items
        list_demand_items = sl.get_items_auctioned(text_input, dataframe, "Demanded_Quantity_Items")
