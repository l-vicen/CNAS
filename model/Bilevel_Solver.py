...
def priceVector_plot(list_items, actual_winning_bids_list, estimated_prices_list, model_prices, demanded_quatities_list):
    ...
    st.write(dataframe)
    fig = px.box(dataframe, y=['Expected Pricing', 'Actual Winning Pricing', 'Model Suggested Pricing'], x="Items", points="all", color=['Expected Pricing', 'Actual Winning Pricing', 'Model Suggested Pricing'])
